...
BEGIN
    ...
    FROM (VALUES
        ...
        ('SOCI','Foreign exchange losses',0.000),('SOCI','Depreciation and amortisation',6939017.000),
        ...
        ('SOCI','Foreign exchange gains',0.000),('SOCI','Other gains',0.000),('SOCI','Revenue from Government',38784076.000),
