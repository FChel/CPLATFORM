    ...
    <main class="norm-workspace">
        ...
        <section class="norm-module-centre">
            ...
            <div class="norm-module-grid">
                ...
                <a class="norm-module-card" href="NORM_Mapping.aspx"><span>Controlled configuration</span><strong>Account mapping</strong><p>Export, update, validate, approve and replay versioned trial-balance mappings with a complete change trail.</p><em>Manage mappings &rarr;</em></a>
