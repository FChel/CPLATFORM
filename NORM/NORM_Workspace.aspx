    ...
    <main class="norm-workspace">
        ...
        <section class="norm-module-centre">
            ...
            <div class="norm-module-grid">
                ...
                <a class="norm-module-card" href="NORM_Mapping.aspx"><span>Controlled configuration</span><strong>Edit mapping workbook</strong><p>See unmapped trial-balance accounts, download the editable workbook and upload completed mapping changes for validation.</p><em>Edit mapping workbook &rarr;</em></a>
