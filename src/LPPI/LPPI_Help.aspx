        ...
        <div class="help-grid">
            ...
            <article class="help-body">
                ...
                <section id="operations">
                    ...
                    The email carries the package summary &mdash; payable and not-payable counts and dollars, broken down by RC-NR (defaulted on finalise) and RC-RL (reload-eligible, returns next cycle) so the recipient can see exactly what has been decided. The link in the email opens the reviewer page read-only. A <em>Notify Preview</em> button sits beside Notify AS Fin and renders that exact email in a popup before you send &mdash; it is available in test mode too, so you can check the wording without dispatching anything.</p>
