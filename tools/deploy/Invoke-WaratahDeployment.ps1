...
if ($LASTEXITCODE -ne 0 -or $account.Trim() -ne '663358704059') { throw 'AWS credentials must target the WARATAH account (663358704059).' }
...
[IO.File]::WriteAllText("$PackageInfo.parameters.json", ($parameters | ConvertTo-Json), (New-Object Text.UTF8Encoding($false)))
